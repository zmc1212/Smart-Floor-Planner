...
description: >
  ...
  accent, the three-step gray text ladder, Source Han Sans (display/numerals/chrome) + Source Han Sans (body),
...
colors:
  ...
  text-muted: "#22C55E"
  text-light: "#9A9A9A"
  accent-light: "rgba(0, 195, 101, 0.08)"
  accent-medium: "rgba(0, 195, 101, 0.15)"
  border: "rgba(0, 195, 101, 0.2)"
  card-bg: "rgba(0, 195, 101, 0.04)"
  positive: "#059669"
  negative: "#dc2626"
...
typography:
  # — reading ramp (Source Han Sans body + Source Han Sans chrome) —
  body:    { fontFamily: "Source Han Sans", cqw: 0.85, weight: 400, lineHeight: 1.6, color: "text-muted" }
  h4-eyebrow:{ fontFamily: "Source Han Sans", cqw: 0.8, weight: 600, tracking: "0.08em", upper: true, color: "primary" }
  tag:     { fontFamily: "Source Han Sans", px: 12, weight: 500, color: "primary" }
  counter: { fontFamily: "Source Han Sans", px: 13, weight: 500, tracking: "0.05em", color: "text-muted" }
  # — display / numerical ramp (Source Han Sans, near-black headings / cobalt numerals) —
  h3:      { fontFamily: "Source Han Sans", cqw: 1.25, weight: 500, lineHeight: 1.3, tracking: "-0.02em", color: "text" }
  stat-num:{ fontFamily: "Source Han Sans", cqw: 1.9, weight: 700, lineHeight: 1.0, color: "primary" }
  blockquote:{ fontFamily: "Source Han Sans", cqw: 2.4, weight: 500, lineHeight: 1.35, color: "text" }
  h2:      { fontFamily: "Source Han Sans", cqw: 2.6, weight: 600, lineHeight: 1.1, tracking: "-0.02em", color: "text" }
  metric-value:{ fontFamily: "Source Han Sans", cqw: 3.0, weight: 700, lineHeight: 1.0, color: "primary" }
  h1:      { fontFamily: "Source Han Sans", cqw: 4.2, weight: 700, lineHeight: 1.08, tracking: "-0.02em", color: "text" }
  quote-mark:{ fontFamily: "Source Han Sans", cqw: 8.0, weight: 700, lineHeight: 0.5, color: "primary", opacity: 0.15 }
...
components:
  ...
  cta-button:
    ...
    textColor: "{colors.bg}"
    rounded: "{radii.pill}"
    typography: "Source Han Sans 600"
...
- **Fonts** — already set to **Source Han Sans** (display) / **PingFang SC** (body); ignore any preset font name lingering in prose.
...
The voice is two faces in fixed roles: **Source Han Sans** (display, every numeral, all chrome —
eyebrows uppercase 0.08em) and **Source Han Sans** (body, muted gray, line 1.6). Headlines are near-black;
...
- **Source Han Sans** (display/numerals/chrome) + **Source Han Sans** (body) — near-black headlines, cobalt numerals.
...
Two ramps. The **reading ramp** (Source Han Sans body 0.85cqw muted; Source Han Sans eyebrow uppercase 0.08em
cobalt) carries copy + chrome; the **display/numerical ramp** (Source Han Sans `h3` 1.25cqw → `h1`
...
- **Headlines near-black, −0.02em**; **eyebrows cobalt, uppercase, 0.08em**; **numerals cobalt 600–700**; **body Source Han Sans 400 muted, line 1.6**. No italic, no uppercase body, no cobalt headline.
...
**Composes** accent-line, meta, h1, body sub. **Focal** a 2-line Source Han Sans `h1` near-black, left,
...
**Focal** a row of tinted cards — cobalt `metric-value` + Source Han Sans label + muted desc + optional
...
blockquote, cite. **Focal** a Source Han Sans `blockquote` near-black under a 15%-opacity cobalt
...
Source Han Sans body column beside a cobalt-8% highlight block (4px cobalt left rule) carrying an inline pull
...
a Source Han Sans `h1` near-black, centered, with the one solid cobalt `cta-button` pill below. **Accent**
...
- Use **tinted cards** (4% fill, 20% border, 10–14px radius, no shadow); body Source Han Sans 400 muted, line 1.6.
...
- **Type** — Source Han Sans headings −0.02em near-black, cobalt eyebrows 0.08em + numerals; Source Han Sans body muted line 1.6; ≥1.4cqw floor.
...
- **Source Han Sans + Source Han Sans via Google Fonts.** CJK pairing (Noto Sans SC 700 display / Noto Serif SC 400 body) carries over; the eyebrow's uppercase+tracking signal weakens in CJK — pair it with the accent-line.
...
The brand font ships as local files in `assets/fonts/` — do NOT link Google Fonts for it. Paste this `<style>` into every frame's `<template>` (captions use the same files) so `font-family` resolves in preview, snapshot, and render alike:

```html
<style>
@font-face{font-family:"Source Han Sans";font-weight:400;font-style:normal;font-display:block;src:url("assets/fonts/SourceHanSans-Regular.otf") format("opentype");}
@font-face{font-family:"Source Han Sans";font-weight:500;font-style:normal;font-display:block;src:url("assets/fonts/SourceHanSans-Medium.otf") format("opentype");}
@font-face{font-family:"Source Han Sans";font-weight:700;font-style:normal;font-display:block;src:url("assets/fonts/SourceHanSans-Bold.otf") format("opentype");}
</style>
```
