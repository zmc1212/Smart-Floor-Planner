...
export default function LeadCommissionsPage() {
  ...
  const [filters, setFilters] = useState({ status: 'all', role: 'all', source: 'all', fromDate: '', toDate: '' });
      ...
      <Card className="border-border shadow-sm">
        ...
        <CardContent className="space-y-5 pt-5">
          <div className="grid gap-3 md:grid-cols-2 xl:grid-cols-5">
            ...
            <Select value={filters.source} onValueChange={(value) => { setPage(1); setFilters((current) => ({ ...current, source: value })); }}><SelectTrigger className="w-full"><SelectValue placeholder="全部来源" /></SelectTrigger><SelectContent><SelectItem value="all">全部来源</SelectItem><SelectItem value="referrer_network">推荐人网络</SelectItem><SelectItem value="staff_activity">员工活动码</SelectItem></SelectContent></Select>
