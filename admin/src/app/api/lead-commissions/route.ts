...
function dto(record: LeadCommissionWithRelations) {
  return {
    ...
    originalPayableAmount: record.originalPayableAmount,
    originalBeneficiaryUserId: record.originalBeneficiaryUserId.toString(),
    adjustedAt: record.adjustedAt,
    adjustedBy: record.adjustedBy?.toString() ?? null,
