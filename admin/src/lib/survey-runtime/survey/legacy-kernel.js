const { deleteWall, deleteClosedSpace } = require('./operations/wall-deletion.js');
...
const { resumeOpenChainAtDanglingNode } = require('./operations/open-chain.js');
const {
...
const { getFirstNode, getLastWall, getLastEndNode, getClosedSpace, getNode, getWall } = require('./core/graph-query.js');
const { nowIso, nextId } = require('./core/runtime-id.js');
const {
...
const { createSurveyDraft, cloneDraft, getActiveFloor: findActiveFloor, touchDraft } = require('./core/draft.js');
