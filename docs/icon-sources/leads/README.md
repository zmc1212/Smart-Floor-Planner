...
user-supplied `design-references/leads-management-v4-icon.png`. They include the
...
`design-references/leads-management-v4-crops/` for design comparison only. They
