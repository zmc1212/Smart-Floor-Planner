# Promotion Detail Reference Derivatives

- Source: `design-references/all-pages-ip-v1/10-promotion-record-detail.png`.
...
- The hero scene is an illustration crop, not a UI micro-icon. Runtime business
  status is rendered as live WXML text over the document stamp instead of relying
  on the status text embedded in the design reference.
