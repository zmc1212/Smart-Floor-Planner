# Commission Records Asset Sources

## Icons

- Source set: Lucide `1.8.0` from the repository-installed
  `admin/node_modules/lucide-react` package.
- License: ISC; the upstream license is stored at
  `admin/node_modules/lucide-react/LICENSE`.
...
- The crop contains only the Xiao K income-assistant scene. Sample record text,
  amounts, dates, and statuses from the design reference are not embedded in
