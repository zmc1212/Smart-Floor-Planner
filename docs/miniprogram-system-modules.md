...
The anonymous free-design claim route's phone-authorisation and
assignment-pending states (`packages/business/free-design-service/free-design-service`)
follow approved designs 11 and 13: the service card or WeChat notice, primary
CTA, and later action stay in one normal-flow group. Compact screens scroll
inside either state instead of creating a viewport-sized gap before the CTA;
its authenticated `390x844` native-capsule capture remains pending.
