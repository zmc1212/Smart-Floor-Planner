...
| --- | --- | --- | --- |
| Customer | `Service / Projects / Mine` | Read owned service progress, current appointment, formal-plan summary, and named published scheme albums; reschedule inside the allowed window | Staff lead pool, formal surveying editor, BLE, AI production tools, conversion/commission administration |
