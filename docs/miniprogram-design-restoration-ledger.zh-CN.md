...
| `packages/business/referrer-workbench/referrer-workbench` | `design-references/miniprogram-airy-minimalist-v1/06-promoter-workbench.jpg` | 已按设计稿 SVG 坐标刷新：胶囊安全区内的 JK 端标识、身份胶囊和扫码/通知视觉动作；324rpx 绿色 Hero、精确 3 联指标与主按钮节奏、推广小 K 资产；136rpx 双列快捷卡；紧凑企业胶囊、带线性图标与发丝分隔线的权益卡、96rpx 推广记录卡，以及按源稿比例收紧的 4 项推广 TabBar。推广工作台与角色导航聚焦测试 9/9 通过；当前 DevTools 窗口没有可验证的 automator endpoint，登录态 `390x844` 宿主截图待补 | 是 |
