...
| `packages/surveying/editor/surveying-editor` | `design-references/surveying/cursor-guide-state-reference-20260812.jpg` | 闭合只保留原生 cover-view「合」按钮，光标放大镜为 120px，右侧工具栏清空与其他工具同构且仅显示「清空」；聚焦测试覆盖这些控件状态，原生胶囊截图待补 | 是 |
