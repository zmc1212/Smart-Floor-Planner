...
| `packages/business/customer-project/customer-project` | `design-references/referrer-network-appointment-v1/phase-5-appointment-calendar-v1.png` | 客户预约卡已实现；真实微信开发者工具 iPhone 12/13 Pro `390x844` 模拟器已确认加载态、顶层路由和含原生胶囊的整窗截图 | 是 |
