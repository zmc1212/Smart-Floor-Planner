...
- Responsibilities: customer lead intake, status tracking, floor plan association, promoter/designer assignment, follow-up records, WeCom group creation, and lead sharing.
...
- Responsibilities: measured floor plan storage, layout viewing, DXF export, BLE measuring device management, device binding verification, and measurement audit logs.
