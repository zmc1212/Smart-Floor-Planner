...
const STATUS_META = Object.freeze({
  pending_settlement: {
    label: '待结算',
    tone: 'pending',
    iconPath: '/images/commission-records-ip-v1/receipt-orange.png'
  },
  paid: {
    label: '已结算',
    tone: 'paid',
    iconPath: '/images/commission-records-ip-v1/receipt-green.png'
  },
  voided: {
    label: '已作废',
    tone: 'voided',
    iconPath: '/images/commission-records-ip-v1/receipt-gray.png'
  }
});
