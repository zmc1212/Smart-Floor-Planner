...
function drawWallBodies(ctx, scene) {
  ...
  // Keep the proven Git rendering contract: each colour group is filled from
  // one classified union ring. Painting source rectangles and junction patches
  // independently gives mixed open/closed junction pixels competing ownership,
  // which produced the device-only hollow/notched T and corner regression.
